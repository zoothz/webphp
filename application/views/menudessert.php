...
<link href="<?php base_url() ?>assets/font-awesome.css" rel="stylesheet"> <!-- font-awesome icons -->
<!-- //Custom-Stylesheet-Links --> 
<!-- Web-Fonts -->
...
<body> 
	...
	<div class="w3layouts-header"> 
		...
		<!-- Slider -->
		<div class="banner">
					<img src="<?php base_url() ?>assets/images/bg_menu_pz.jpg" class="layer1" alt="Veg Mores">
	...
	<div id="menupizza" class="Menuchinhpizza">
			<div class="DetailMenupizza">
				<div class="pizza">
					<a href="MenuPizza" class="hover">Pizza /</a>
				</div>
				<div class="food">
					<a href="MenuFood" class="hover">Food /</a>
				</div>
				<div class="dessert">
					<a href="#infoDessert" class="hover">Dessert</a>
				</div>
			</div>
	</div>
