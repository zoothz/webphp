		...
		<div class="row">
			<div class="col-sm-10 push-sm-1">
				<div class="jumbotron text-xs-center">
							<h1 class="display-3">Sửa 1 tin dessert</h1>
					...
					<div class="formthemmoi">
                        ...
                        <?php foreach ($dulieusua as $value): ?>
							...
							<fieldset class="form-group">
							<img src="<?php echo $value['anhdessert'] ?>" alt="" class="img-fluid">
							<input type="hidden" value="<?php echo $value['anhdessert'] ?>" name="anhcu">
								<label for="formGroupExampleInput">Ảnh tin</label>
 								<input name="anhdessert" type="file" class="form-control" placeholder="Ảnh dessert ">
							</fieldset>
