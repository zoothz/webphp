		...
		<div class="row">
			<div class="col-sm-10 push-sm-1">
				<div class="jumbotron text-xs-center">
							<h1 class="display-3">Sửa 1 tin pizza</h1>
							<p class="lead">Sửa nội dung của 1 tin.</p>
							<hr class="m-y-md">
							 
						</div>
					<div class="formthemmoi">
						<form action="<?= base_url(); ?>admin/updatepizza" method="post" enctype="multipart/form-data">
                        <?php foreach ($dulieusua as $value): ?>
							...
							<fieldset class="form-group">
							<img src="<?php echo $value['anhpizza'] ?>" alt="" class="img-fluid">
							<input type="hidden" value="<?php echo $value['anhpizza'] ?>" name="anhcu">
								<label for="formGroupExampleInput">Ảnh tin</label>
 								<input name="anhpizza" type="file" class="form-control" placeholder="Ảnh Pizza ">
							</fieldset>
							...
							<div class="row">
								...
								<a href="<?= base_url(); ?>admin/xoapizza/<?php echo $value['id'] ?>" class="btn btn-outline-danger btn-block btn-lg"  >
								Xóa 
								</a>
								</div>
							</div>
